                ...
                >
                    ...
                    >
                        ...
                        <v-field
                            ...
                            class="custom-select block w-full mb-3 py-3 px-5 bg-white border border-[#E9E9E9] rounded-lg text-base text-[#6E6E6E] focus:ring-blue-500 focus:border-blue-500 max-md:outline-none max-md:w-[110px] cursor-pointer"
