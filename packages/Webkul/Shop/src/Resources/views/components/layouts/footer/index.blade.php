      ...
      <div class="grid grid-cols-[2fr_3fr_1fr] gap-8 py-10 ">
        ...
        <div class="">
          ...
          <form class="grid grid-cols-1 md:grid-cols-2 gap-2" action="">
            ...
            <button class="col-span-2 w-full h-12 bg-indigo-600 hover:bg-indigo-800 transition-all duration-700 rounded-full shadow-xs text-white text-base font-semibold leading-6">@lang('shop::app.components.layouts.footer.pages')</button>
          </form>
        </div>
        <!--End Col-->
