    ...
    @pushOnce('scripts')
        ...
        >
            <div class="container px-[60px] max-lg:px-8 max-sm:px-4 md:mb-16 mb-8">
                <div class="grid md:grid-cols-[400px_auto] grid-cols-1 gap-10 items-start md:mt-10 max-lg:gap-5">
                    ...
                    <div class="flex-1">
                        ...
                        <div v-else class="mt-8">
                            <!-- Product Card Shimmer Effect -->
                            <template v-if="isLoading">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-sm:justify-items-center max-sm:gap-4">
                        ...
                        <!-- Load More Button -->
                        <button
                            class="secondary-button block mx-auto w-max py-3 mt-14 px-11 rounded-full text-base text-center"
                        ...
                        <button
                            ...
                            class="secondary-button block w-max mx-auto py-3.5 mt-14 px-[74.5px] rounded-full text-base text-center"
                        >
                            <!-- Spinner -->
                            <img
