        ...
        foreach ($product->attribute_family->custom_attributes as $attribute) {
            ...
            if (
                ...
                $data[$attribute->code] = gettype($data[$attribute->code]) === 'object'
                    ? request()->file($attribute->code)->storeAs('product/'.$product->id, Str::random(40).'.'.request()->file($attribute->code)->getClientOriginalExtension())
                    : $data[$attribute->code];
            }
    ...
    public function prepareForCart($data)
    {
        ...
        $products = [
            [
                ...
                'total_weight'      => isset($this->product->weight) && $this->product->weight != "" ? $this->product->weight * $data['quantity'] : 0,
                'base_total_weight' => isset($this->product->weight) && $this->product->weight != "" ? $this->product->weight * $data['quantity'] : 0,
